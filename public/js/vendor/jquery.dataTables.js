...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+' form-control input-sm" placeholder="Buscar" style="font-size:8pt; background-color:#F3F3F3;"/>';
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select/>', {
			...
			'style': 		 'font-size:8pt; background-color:#F3F3F3;'
		} );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sLengthMenu": "_MENU_", /*CANTIDAD DE ENTRADAS MOSTRAR*/
